...
type Props = { lang: string; userName: string; userRole: string; logoutAction: () => Promise<void> };
...
export default function Sidebar({ lang, userName, userRole, logoutAction }: Props) {
  ...
  return (
    <aside className="hidden md:flex md:w-56 md:flex-col md:fixed md:inset-y-0 border-r border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-stone-900">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {navItems(lang, userRole).map((item) => {
          const active =
            item.href === `/${lang}`
