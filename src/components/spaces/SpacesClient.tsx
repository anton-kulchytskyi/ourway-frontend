...
export default function SpacesClient({ initialSpaces, token, lang }: Props) {
  ...
  async function handleDelete(id: number) {
    if (!confirm("Delete this space? All tasks in it will be deleted too.")) return;
    try {
    ...
    <div className="flex flex-col gap-4">
      ...
      {showCreate && (
        <>
          ...
          <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-stone-900 shadow-xl max-h-[90dvh] flex flex-col pointer-events-auto">
      ...
      {inviteSpace && (
        <>
          <div className="fixed inset-0 z-40 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4" onClick={closeInvite} />
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-stone-900 shadow-xl pointer-events-auto">
